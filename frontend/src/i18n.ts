...
const en = {
  ...
  'nav.logout': 'Sign out',
  'auth.login.title': 'Sign in to SubsKeeper',
  'auth.login.description': 'Link your Google account to keep subscriptions and reminders in sync.',
  'auth.login.google': 'Continue with Google',
  'auth.login.error': 'Could not start Google sign-in. Please try again.',
  'auth.callback.verifying': 'Validating credentials...',
  'auth.callback.success': 'Signed in successfully.',
  'auth.callback.pending': 'Check your inbox to verify the email address linked to your Google account.',
  'auth.callback.error': 'Sign-in failed. Please retry the login flow.',
  'auth.verify.title': 'Email verification',
  'auth.verify.success': 'Email confirmed. Thank you!',
  'auth.verify.pending': 'Follow the link from your inbox to finish verification.',
  'auth.verify.cta': 'Return to dashboard',
  'auth.verify.error': 'Verification link is invalid or has expired.',
  ...
  'settings.telegram.sectionTitle': 'Telegram bot',
  'settings.telegram.sectionDescription': 'Link Telegram to receive reminders right in chat.',
  'settings.telegram.sectionSubtitle': 'We only send alerts about upcoming renewals.',
  'settings.telegram.botHandle': 'Bot handle: {handle}',
  'settings.telegram.botUnavailable': 'Telegram bot is not configured yet. Ask the administrator to set TELEGRAM_BOT_NAME.',
  'settings.telegram.status.loading': 'Checking status...',
  'settings.telegram.status.connected': 'Bot linked',
  'settings.telegram.status.disconnected': 'Not linked yet',
  'settings.telegram.status.linkedAt': 'Linked {date}',
  'settings.telegram.status.chatId': 'Delivering to chat #{chatId}',
  'settings.telegram.actions.refreshStatus': 'Check status',
  'settings.telegram.actions.refreshing': 'Checking...',
  'settings.telegram.actions.generate': 'Get link',
  'settings.telegram.actions.regenerate': 'Refresh link',
  'settings.telegram.actions.generating': 'Creating...',
  'settings.telegram.actions.openBot': 'Open Telegram',
  'settings.telegram.actions.copyLink': 'Copy link',
  'settings.telegram.actions.copyToken': 'Copy token',
  'settings.telegram.tokenLabel': 'Deep link',
  'settings.telegram.codeLabel': 'Security token',
  'settings.telegram.tokenPending': 'Waiting for you to finish linking...',
  'settings.telegram.linkExpires': 'Link expires {relative}',
  'settings.telegram.linkExpired': 'This link expired. Generate a new one.',
  'settings.telegram.instructionsTitle': 'How linking works',
  'settings.telegram.instructions.step1': 'Generate a one-time link. It stays valid for 10 minutes.',
  'settings.telegram.instructions.step2': 'Open Telegram using the link and press Start.',
  'settings.telegram.instructions.step3': 'We’ll confirm the connection automatically and send a welcome message.',
  'settings.telegram.emptyState': 'Create a link to start the bot.',
  'settings.telegram.toast.generated.title': 'Link ready',
  'settings.telegram.toast.generated.description': 'Use it within the next 10 minutes.',
  'settings.telegram.toast.error.title': 'Could not request link',
  'settings.telegram.toast.error.description': 'Please retry in a few seconds.',
  'settings.telegram.toast.statusError.title': 'Could not load status',
  'settings.telegram.toast.statusError.description': 'Refresh the page or try again.',
  'settings.telegram.toast.linkCopied.title': 'Link copied',
  'settings.telegram.toast.tokenCopied.title': 'Token copied',
  'settings.telegram.toast.copyError.title': 'Could not copy',
  'settings.telegram.toast.copyError.description': 'Select the text manually and copy it.',
...
const ru: TranslationDictionary = {
  ...
  'nav.logout': 'Выйти',
  'auth.login.title': 'Войти в SubsKeeper',
  'auth.login.description': 'Свяжите аккаунт Google, чтобы синхронизировать подписки и напоминания.',
  'auth.login.google': 'Продолжить с Google',
  'auth.login.error': 'Не удалось начать вход через Google. Повторите попытку.',
  'auth.callback.verifying': 'Проверяем данные...',
  'auth.callback.success': 'Вы успешно вошли в систему.',
  'auth.callback.pending': 'Проверьте почту и подтвердите адрес, связанный с Google.',
  'auth.callback.error': 'Ошибка входа. Попробуйте авторизоваться снова.',
  'auth.verify.title': 'Подтверждение почты',
  'auth.verify.success': 'Почта подтверждена. Спасибо!',
  'auth.verify.pending': 'Перейдите по ссылке из письма, чтобы завершить подтверждение.',
  'auth.verify.cta': 'Вернуться на главную',
  'auth.verify.error': 'Ссылка недействительна или истекла.',
  ...
  'reminders.snooze': 'Отложить на 1 день',
  ...
  'settings.emailPlaceholder': 'you@example.com',
  'settings.telegram.sectionTitle': 'Telegram-бот',
  'settings.telegram.sectionDescription': 'Подключите Telegram, чтобы получать напоминания прямо в чате.',
  'settings.telegram.sectionSubtitle': 'Мы пишем только о приближающихся платежах.',
  'settings.telegram.botHandle': 'Имя бота: {handle}',
  'settings.telegram.botUnavailable': 'Telegram-бот пока не настроен. Попросите администратора указать TELEGRAM_BOT_NAME.',
  'settings.telegram.status.loading': 'Проверяем статус...',
  'settings.telegram.status.connected': 'Бот подключён',
  'settings.telegram.status.disconnected': 'Ещё не подключено',
  'settings.telegram.status.linkedAt': 'Связано {date}',
  'settings.telegram.status.chatId': 'Доставляем в чат №{chatId}',
  'settings.telegram.actions.refreshStatus': 'Проверить статус',
  'settings.telegram.actions.refreshing': 'Проверяем...',
  'settings.telegram.actions.generate': 'Получить ссылку',
  'settings.telegram.actions.regenerate': 'Обновить ссылку',
  'settings.telegram.actions.generating': 'Создаём...',
  'settings.telegram.actions.openBot': 'Открыть Telegram',
  'settings.telegram.actions.copyLink': 'Скопировать ссылку',
  'settings.telegram.actions.copyToken': 'Скопировать токен',
  'settings.telegram.tokenLabel': 'Персональная ссылка',
  'settings.telegram.codeLabel': 'Секретный токен',
  'settings.telegram.tokenPending': 'Ждём, пока вы завершите привязку...',
  'settings.telegram.linkExpires': 'Ссылка истекает {relative}',
  'settings.telegram.linkExpired': 'Срок ссылки истёк. Создайте новую.',
  'settings.telegram.instructionsTitle': 'Как проходит привязка',
  'settings.telegram.instructions.step1': 'Сгенерируйте одноразовую ссылку. Она действует 10 минут.',
  'settings.telegram.instructions.step2': 'Откройте Telegram по ссылке и нажмите «Start».',
  'settings.telegram.instructions.step3': 'Мы автоматически подтвердим связь и отправим приветственное сообщение.',
  'settings.telegram.emptyState': 'Сгенерируйте ссылку, чтобы запустить бота.',
  'settings.telegram.toast.generated.title': 'Ссылка готова',
  'settings.telegram.toast.generated.description': 'Используйте её в течение ближайших 10 минут.',
  'settings.telegram.toast.error.title': 'Не удалось получить ссылку',
  'settings.telegram.toast.error.description': 'Попробуйте снова через несколько секунд.',
  'settings.telegram.toast.statusError.title': 'Не удалось загрузить статус',
  'settings.telegram.toast.statusError.description': 'Обновите страницу или повторите попытку.',
  'settings.telegram.toast.linkCopied.title': 'Ссылка скопирована',
  'settings.telegram.toast.tokenCopied.title': 'Токен скопирован',
  'settings.telegram.toast.copyError.title': 'Не удалось скопировать',
  'settings.telegram.toast.copyError.description': 'Выделите текст вручную и скопируйте.',
