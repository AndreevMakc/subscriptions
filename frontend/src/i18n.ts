...
const en = {
  ...
  'nav.importFailed.partial': 'Some subscriptions could not be imported. Check the JSON and try again.',
  ...
  'footer.offline': 'syncs with a secure backend so your data stays accessible across devices.',
  ...
  'toast.error.generic.description': 'Unable to reach the server. Try again shortly.',
...
const ru: TranslationDictionary = {
  ...
  'nav.importFailed.partial': 'Некоторые подписки не удалось импортировать. Проверьте JSON и повторите попытку.',
  ...
  'footer.offline': 'синхронизируется с защищённым бэкендом, чтобы данные были доступны везде.',
  ...
  'toast.close': 'Закрыть',
  'toast.error.generic.title': 'Ошибка запроса',
  'toast.error.generic.description': 'Не удалось связаться с сервером. Попробуйте позже.',
